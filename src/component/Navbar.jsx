        ...
        <nav className="flex items-center justify-between px-12 py-6 sticky w-full z-50">
            <div className="text-[1.6rem] font-semibold text-slate-800 flex items-center gap-2">
                ...
                <span className="relative flex flex-col">
                    <span className="w-3 h-3 bg-white rounded-full -ml-1"></span>
                    <span className="w-5 h-5 bg-white rounded-full -mt-2"></span>
                </span>
            ...
            <button className=" border-slate-800 rounded-xl border-[1.5px] px-8 py-2.5 flex items-center gap-2 hover:bg-slate-50 transition text-sm font-medium uppercase">
                Get the App <img src="../../public/play-store-logo.svg"  alt="play-store-logo" className="h-5 m-auto"/>
            </button>
        </nav>
    );
}
